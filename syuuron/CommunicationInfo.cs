...
namespace syuuron {
     ...
     */
     public class CommunicationTypeInfo {
        ...
        static public CommunicationTypeInfo GetCommunicationInfo(string CommunicatonType) {
            try { 
                 return CommunicationInfoDictionary[CommunicatonType];
            }
            catch {
                throw new Exception("通信の名前が不適切です" + CommunicatonType);
            }
        }
    }
}
